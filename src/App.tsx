    ...
    <div className="min-h-screen text-foreground flex flex-col p-4 md:p-8 relative z-10">
        ...
        <div className="col-span-1 flex flex-col gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Supported formats: JPEG, PNG, WebP, GIF</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className='md:sticky top-4'>
            ...
            <CardContent>
              <div className="flex-grow">
                {image ? (
                  <AspectRatio ratio={image ? image.width / image.height : 16 / 9}>
                    <DitherCanvas
                      ref={canvasRef}
                      image={image}
                      options={options}
      ...
      <footer className='mt-8 flex flex-col items-center opacity-50 gap-2'>
        <p className="text-center text-sm text-muted-foreground">
          Made with ❤️ by <a href='https://mxte.cc' className='font-bold'>Maxtune</a>
        </p>
        <a href='https://github.com/maxtunelee/dither-me'><SiGithub /></a>
      </footer>
    </div>
  );
}
