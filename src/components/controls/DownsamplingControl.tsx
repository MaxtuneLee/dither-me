...
export function DownsamplingControl({
	options,
	onOptionsChange,
}: DownsamplingControlProps) {
	const handleDownSamplingChange = useCallback(
		(value: string) => {
			onOptionsChange({
				...options,
	...
	return (
		<div>
			...
			<CardDescription className=" mb-4">
				Reduces image size before processing to improve performance and dither
				effect visibility
			</CardDescription>
			<Select
