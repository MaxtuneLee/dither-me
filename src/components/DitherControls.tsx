...
export function DitherControls({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ColorPaletteControl options={options} onOptionsChange={onOptionsChange} />
      <ImagePreprocessingControl options={options} onOptionsChange={onOptionsChange} />
      <DownsamplingControl options={options} onOptionsChange={onOptionsChange} />
      <Button
        onClick={onDownload}
